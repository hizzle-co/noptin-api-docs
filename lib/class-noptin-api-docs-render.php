...
function the_content( $content ) {
	...
	$before_content = ( 'wp-parser-hook' === $post->post_type ) ? $this->get_hook_prototype() : $this->get_prototype();
	...
	$args = ( 'wp-parser-hook' === $post->post_type ) ? $this->get_hook_arguments() : $this->get_arguments();
...
function is_function_deprecated() {
	 ...
	 */
	return apply_filters( 'wp_parser_is_function_deprecated', $this->is_deprecated() );
}
